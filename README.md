...
## [Setup](Setup)
The setup can be quite a nuisance but once completed is rarely seen again, To use this SDK, download/clone the entire project to your local computer. To setup the code you can use the recommended way of installing android studio, then install java and set up the dependencies. Or you could be a total baller and set it up manually and use the gradle files to build and install the code using your prefered IDE. Click Setup link for in depth information on both options.
